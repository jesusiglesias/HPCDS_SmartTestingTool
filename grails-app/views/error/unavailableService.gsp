    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2 text-center">
            ...
            <h3 class="h3 description-error">
                ${raw(g.message(code: "views.errors.description.unavailableService", default: 'Oops! <strong>Service is currently not available.</strong> <br/> Please try again later.'))}</h3>
        </div>
    </div>
</div>
</body>
