                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 30px; text-align: center; font-family: roboto, sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
                                    <h3> <g:message code="customTasksUser.login.stateAccount.description.title.noRole" default="Notification of existence of user without role"/> </h3>
                                    <p> ${raw(stateAccountMessage)} </p>
                                </td>
                            </tr>
                        </table>
                    </td>
