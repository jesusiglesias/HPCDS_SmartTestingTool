        ...
        <div class="col-md-6">
            <div class="form-group group-subtitle ${hasErrors(bean: questionInstance, field: 'titleQuestionKey', 'error')}">
                ...
                <div class="input-group input-icon right">
                    ...
                    <g:textField name="titleQuestionKey" class="form-control form-shadow emptySpaces key-question backend-input" maxlength="25" value="${questionInstance?.titleQuestionKey}"/>
