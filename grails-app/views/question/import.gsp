                    ...
                    <div class="col-md-12 col-lg-10 col-lg-offset-1">
                        ...
                        <div class="portlet light bg-inverse logConfig-portlet">
                            <div class="portlet-title">
                                ...
                                <div>
                                    <a href="${resource(dir: 'files', file: 'STT_QuestionTemplate.csv')}" download="" class="btn green-dark button-template"><i class="fa fa-download" aria-hidden="true"></i><g:message code="default.import.template" default="Template"/></a>
                                </div>
                            </div>
