...
<body>
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h3 class="page-title">
                ...
                <small><g:message code="layouts.main_auth_admin.body.subtitle.question.import" default="Import questions"/></small>
            </h3>
            ...
            <div id="list-panel">
                    ...
                    <div class="col-md-12 col-lg-10 col-lg-offset-1">
                        ...
                        <div class="portlet light bg-inverse logConfig-portlet">
                            <div class="portlet-title">
                                ...
                                <div>
                                    <a href="${resource(dir: 'files', file: 'STT_QuestionTemplate.csv')}" download="" class="btn green-dark button-template icon-button-container"><i class="fa fa-download icon-button" aria-hidden="true"></i><g:message code="default.import.template" default="Template"/></a>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-10 col-lg-offset-1">
                        <!-- Upload CSV file -->
                        <g:uploadForm uri="/question/uploadFile" class="question-import-form">
                            <div class="fileinput fileinput-new fileinput-import" data-provides="fileinput">
                                <div class="input-group btn-block input-import">
                                    ...
                                    <span class="input-group-addon btn btn-block grey-gallery btn-file">
                                        ...
                                        <input type="file" accept="text/comma-separated-values, text/csv, application/csv, application/excel, application/vnd.ms-excel, application/vnd.msexcel, text/anytext" name="importFileQuestion" id="importFileQuestion" required />
                                    </span>
                            ...
                            <div class="importData-button">
                                <button type="submit" name="question-import-button" id="question-import-button" class="btn green-dark btn-block">
    ...
    <g:javascript src="import-validation/questionImport-validation.js"/>
