...
<body>
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h3 class="page-title">
                ...
                <small><g:message code="layouts.main_auth_admin.body.subtitle.topic.import" default="Import topics"/></small>
            </h3>
            ...
            <div id="list-panel">
                    ...
                    <div class="col-md-12 col-lg-10 col-lg-offset-1">
                        ...
                        <div class="portlet light bg-inverse logConfig-portlet">
                            <div class="portlet-title">
                                ...
                                <div>
                                    <a href="${resource(dir: 'files', file: 'STT_TopicTemplate.csv')}" download="" class="btn green-dark button-template icon-button-container"><i class="fa fa-download icon-button" aria-hidden="true"></i><g:message code="default.import.template" default="Template"/></a>
                                </div>
                            </div>
                            ...
                            <div class="portlet-body">
                                <div class="scroller" style="height:490px" data-rail-visible="1" data-rail-color="#105d41" data-handle-color="#4A9F60">
                                    ...
                                    <p>
                                        ${raw(g.message(code: 'default.import.description.topic', default: 'To import correctly the topics, you must follow the following scheme: <strong>| Name<span style="color: #D05454">*</span> | ' +
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-10 col-lg-offset-1">
                        <!-- Upload CSV file -->
                        <g:uploadForm uri="/topic/uploadFile" class="topic-import-form">
                            <div class="fileinput fileinput-new fileinput-import" data-provides="fileinput">
                                <div class="input-group btn-block input-import">
                                    ...
                                    <span class="input-group-addon btn btn-block grey-gallery btn-file">
                                        ...
                                        <input type="file" accept="text/comma-separated-values, text/csv, application/csv, application/excel, application/vnd.ms-excel, application/vnd.msexcel, text/anytext" name="importFileTopic" id="importFileTopic" required />
                                    </span>
                            ...
                            <div class="importData-button">
                                <button type="submit" name="topic-import-button" id="topic-import-button" class="btn green-dark btn-block">
    ...
    <g:javascript src="import-validation/topicImport-validation.js"/>
