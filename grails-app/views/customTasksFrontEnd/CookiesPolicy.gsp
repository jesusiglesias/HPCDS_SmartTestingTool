            ...
            <div class="page-title-user-cookie-section">
                ...
                <p class="page-title-user-cookie-section-description">
                    ${raw(g.message(code:"layouts.main_auth_user.body.title.cookie.section.three.description", default:"You may stop accepting browser cookies, or stop accepting cookies from a particular service by modifying your browser settings. " +
                            ...
                            " <a href='https://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-que-los-sitios-we'>https://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-que-los-sitios-we</a>.<br><br> <span class='sbold'>INTERNET EXPLORER</span> <br> " +
                            "<a href='http://windows.microsoft.com/es-es/internet-explorer/delete-manage-cookies'>http://windows.microsoft.com/es-es/internet-explorer/delete-manage-cookies</a>.<br><br> <span class='sbold'>SAFARI</span> <br> " +
                            "<a href='https://support.apple.com/es-es/HT201265'>https://support.apple.com/es-es/HT201265</a>.<br><br> <span class='sbold'>OPERA</span> <br> " +
                            "<a href='https://www.opera.com/help/tutorials/security/privacy/'>https://www.opera.com/help/tutorials/security/privacy/</a>.<br><br> For more information, you can consult your browser support or the company owning the browser."))}
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="page-title-user-cookie-section">
                ...
                <p class="page-title-user-cookie-section-description">
                    ${raw(g.message(code:"layouts.main_auth_user.body.title.cookie.section.four.description", default:"<strong>If you continue browsing once informed about the cookies policy, we understand that you accept the use of cookies by the platform.</strong> However, you can change your " +
                            ...
                            "following address: <a href=\"mailto:smartestingtool.info@gmail.com\">smartestingtool.info@gmail.com</a>."))}
                </p>
            </div>
        </div>
    </div>
