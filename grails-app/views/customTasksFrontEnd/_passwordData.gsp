        ...
        <div class="col-lg-6 col-lg-offset-3">
            <div class="form-group">
                <label for="currentPassword" class="control-label">
                    <h5 class="sbold">
                        <g:message code="layouts.main_auth_user.content.myProfile.sidebar.oldPassword.title" default="Current password"/>
        ...
        <div class="col-lg-6 col-lg-offset-3">
            <div class="form-group">
                <label for="password" class="control-label">
                    <h5 class="sbold">
                        <g:message code="layouts.main_auth_user.content.myProfile.sidebar.newPassword.title" default="New password"/>
                        <span class="required"> * </span>
                    </h5>
                </label>
                <div class="input-icon right">
        ...
        <div class="col-lg-6 col-lg-offset-3">
            <div class="form-group">
                <label for="confirmPassword" class="control-label">
                    <h5 class="sbold">
                        <g:message code="layouts.main_auth_user.content.myProfile.sidebar.confirmPassword.title" default="Confirm password"/>
                        <span class="required"> * </span>
                    </h5>
                </label>
                <div class="input-icon right">
