                    ...
                    <div class="col-md-12 col-lg-10 col-lg-offset-1">
                        ...
                        <div class="portlet light bg-inverse logConfig-portlet">
                            <div class="portlet-title">
                                ...
                                <div>
                                    <a href="${resource(dir: 'files', file: 'STT_DepartmentTemplate.csv')}" download="" class="btn green-dark button-template icon-button-container"><i class="fa fa-download icon-button" aria-hidden="true"></i><g:message code="default.import.template" default="Template"/></a>
                                </div>
                            </div>
                            ...
                            <div class="fileinput fileinput-new fileinput-import" data-provides="fileinput">
                                <div class="input-group btn-block input-import">
                                    ...
                                    <span class="input-group-addon btn btn-block grey-gallery btn-file">
                                        ...
                                        <input type="file" accept="text/comma-separated-values, text/csv, application/csv, application/excel, application/vnd.ms-excel, application/vnd.msexcel, text/anytext" name="importFileDepartment" id="importFileDepartment" required />
                                    </span>
