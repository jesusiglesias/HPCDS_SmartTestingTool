...
<div id="cookie-container" class="row" style="display: none">
    <div id="cookie-message" class="col-xs-12">
        ...
        <div>
            <g:link controller="customTasksFrontEnd" action="cookiesPolicy" class="btn blue-chambray btn-sm"><g:message code="layouts.main_auth_user.body.content.cookie.information" default="More information"/></g:link>
