    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h3 class="page-title">
                ...
                <small><g:message code="layouts.main_auth_admin.body.subtitle.evaluation.edit" default="Edit evaluation"/></small>
            </h3>
            ...
            <div id="edit-domain">
                ...
                <g:if test="${flash.evaluationErrorMessage}">
                    <div class='alert alert-error alert-danger-custom-backend alert-dismissable alert-entity-error fade in'>
                        ...
                        <span role="status"> ${raw(flash.evaluationErrorMessage)} </span>
                    </div>
                ...
                <!-- Edit form -->
                <g:form url="[resource:evaluationInstance, action:'update']" method="PUT" autocomplete="on" class="horizontal-form admin-form">
                    <g:hiddenField name="version" value="${evaluationInstance?.version}" />
                    <fieldset class="form">
                        <g:render template="form"/>
                    </fieldset>
