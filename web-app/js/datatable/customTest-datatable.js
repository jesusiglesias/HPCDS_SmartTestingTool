...
var DatatableTestList = function () {
    ...
    var initTestTable = function () {
        ...
        var oTable = table.dataTable({
            ...
            buttons: [
                { extend: 'print', className: 'btn dark btn-outline', text: _print, exportOptions: {columns: [0, 1, 2, 3, 4, 5, 6, 7, 9, 10]} },
                { extend: 'copy', className: 'btn red-sunglo btn-outline', text: _copy, exportOptions: {columns: [0, 1, 2, 3, 4, 5, 6, 7, 9, 10]} },
                { extend: 'pdf', className: 'btn green-dark btn-outline', text: _pdf, filename: _testFile, title: _testTableTitle, exportOptions: {columns: [0, 1, 2, 3, 4, 5, 6, 7, 9, 10]} },
                { extend: 'csv', className: 'btn blue-steel btn-outline', text: _csv, fieldSeparator: ';', filename: _testFile, exportOptions: {columns: [0, 1, 2, 3, 4, 5, 6, 7, 9, 10]} },
