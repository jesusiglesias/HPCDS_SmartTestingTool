    ...
    var initQuestionTable = function () {
        ...
        var oTable = table.dataTable({
            ...
            buttons: [
                ...
                { extend: 'pdf', className: 'btn green-dark btn-outline transparent hvr-bounce-to-top-pdf', text: _pdf, filename: _questionFile, title: _questionTableTitle, exportOptions: {columns: [0, 1, 2, 3, 5, 6]} },
                { extend: 'csv', className: 'btn blue-steel btn-outline transparent hvr-bounce-to-top-csv', text: _csv, fieldSeparator: ';', filename: _questionFile, exportOptions: {columns: [0, 1, 2, 3, 5, 6]} },
