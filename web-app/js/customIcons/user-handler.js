...
var iconUserHandler = function () {
    ...
    var handlerIconUser = function() {
        ...
        var userAddress = $('.address-user');
        var iconUserAddress = $('.i-delete-user-address');
        var userCity = $('.city-user');
        var iconUserCity = $('.i-delete-user-city');
        var userCountry = $('.country-user');
        var iconUserCountry = $('.i-delete-user-country');
        var userPhone = $('.phone-user');
        var iconUserPhone = $('.i-delete-user-phone');
